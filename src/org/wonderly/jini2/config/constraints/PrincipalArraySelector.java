...
public class PrincipalArraySelector extends BaseSelector {
	public PrincipalArraySelector( String desc, ConstraintType type ) {
		super( desc, type );
		Packer pk = new Packer(comp);
		pk.pack( new JLabel( "Principal Array:" )
		...
		pk.pack( new JPanel() ).gridx(1).gridy(++y).fillx().weightx(0);
	}
